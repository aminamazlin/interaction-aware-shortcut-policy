...
from ..policy.diffusion_transformer_lowdim_policy import DiffusionTransformerLowdimPolicy
...
class TrainDiffusionTransformerLowdimWorkspace(BaseWorkspace):
    """Lowdim Diffusion Policy transformer workspace."""
    ...
    def __init__(self, cfg, output_dir=None):
        ...
        if not isinstance(self.model, DiffusionTransformerLowdimPolicy):
            raise TypeError(
                "TrainDiffusionTransformerLowdimWorkspace requires "
                "DiffusionTransformerLowdimPolicy, got "
